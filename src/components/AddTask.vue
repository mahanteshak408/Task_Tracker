                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input v-model="formData.title" type="title" name="title" id="title"
                                class="block w-1/2 lg:w-full p-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
